  ...
  module Options
    describe '#parse_subcommand_options' do
      ...
      describe 'when the subcommand is not init' do
        ...
        it 'calls parse_options_file with subcommand options file' do
        ...
        it 'calls parse_options_file with home directory options file' do
          allow(parser).to receive(:execute_subcommand?).with('provision').and_return true
        ...
        it 'returns empty options hash if file does not exist' do
